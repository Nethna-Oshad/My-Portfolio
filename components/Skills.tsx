...
const defaultCategories: Categories = {
  Frontend: [
    ...
    {
      name: "Framer Motion",
      icon: "devicon-framermotion-plain", // Replace if not available
  ...
  Tools: [
    ...
    {
      name: "Figma",
      icon: "devicon-figma-plain colored", // Using Devicon for consistency
        ...
        <div className="flex flex-wrap justify-center mb-8 sm:mb-12 gap-2 sm:gap-4">
          {Object.keys(categories).map((category: string) => (
            <button
              ...
              className={`px-4 sm:px-6 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base ${
